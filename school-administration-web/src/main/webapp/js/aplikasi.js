angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
        $routeProvider
            ...
            .when('/report/teacher', {templateUrl: 'pages/report/teacher.html', controller: 'TeacherController'})
            .when('/master/class', {templateUrl: 'pages/master/class.html', controller: 'KelasController'})
            .when('/report/mapclass', {templateUrl: 'pages/report/mapclass.html'})
            .when('/report/class', {templateUrl: 'pages/report/class.html', controller: 'KelasController'})
            ...
            .when('/master/lesson', {templateUrl: 'pages/master/lesson.html', controller: 'LessonController'})
            .when('/report/lesson', {templateUrl: 'pages/report/lesson.html', controller: 'LessonController'})
            .when('/master/job', {templateUrl: 'pages/master/job.html'})
            .when('/master/cas', {templateUrl: 'pages/master/cas.html', controller: 'CasController'})
            .when('/report/cas', {templateUrl: 'pages/report/cas.html', controller: 'CasController'})
            .when('/master/mapclass', {templateUrl: 'pages/master/mapclass.html'})
            .when('/report/major', {templateUrl: 'pages/report/major.html', controller: 'MajorController'})
            .when('/master/major', {templateUrl: 'pages/master/major.html', controller: 'MajorController'})

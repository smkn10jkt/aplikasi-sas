angular.module('belajar.controller',['belajar.service'])
    ...
    .controller('KelasController', ['$scope', 'KelasService', 'MajorService', function($scope, KelasService, MajorService){
        $scope.kelases = KelasService.query();
        console.log("isi kelases --> ", $scope.kelases);
        $scope.majors = MajorService.query();
        $scope.edit = function(x){
            if(x.id == null){
                return;
...
.controller('LessonController', ['$scope', 'LessonService', 'MajorService', function($scope, LessonService, MajorService){
        ...
        $scope.simpan = function(){
            LessonService.save($scope.currentLesson)
            .success(function(){
                $scope.lessons = LessonService.query();
                $scope.baru();
            });
